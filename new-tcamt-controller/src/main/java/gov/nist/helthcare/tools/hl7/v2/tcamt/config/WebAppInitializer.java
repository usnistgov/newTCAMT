 ...
 */
package gov.nist.helthcare.tools.hl7.v2.tcamt.config;
...

{
	...
	public void onStartup( ServletContext servletContext)
		...
		root.setConfigLocation("gov.nist.helthcare.tools.hl7.v2.tcamt.config");
		root.setServletContext(servletContext);

		root.scan("gov.nist.healthcare.tools.hl7.v2.tcamt",
				"gov.nist.healthcare.nht.acmgt");
		// web app servlet
		servletContext.addListener(new ContextLoaderListener(root));
		Dynamic servlet = servletContext.addServlet("tcamt",
